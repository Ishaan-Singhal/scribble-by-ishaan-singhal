...
class RedirectionsController < ApplicationController
  ...
  def create
    ...
    respond_with_success(t("successfully_created", entity: "Redirection path"))
  end

  def update
    @redirection.update!(from: redirection_params[:from], to: redirection_params[:to])
    respond_with_success(t("successfully_updated", entity: "Redirection path"))
  end

  def destroy
    @redirection.destroy!
    respond_with_success(t("successfully_deleted", entity: "Redirection path"))
  end
